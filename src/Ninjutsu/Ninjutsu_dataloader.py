...
from src.Ninjutsu.skeleton import InhouseStudioSkeleton
from src.Ninjutsu.visualizer import plot_contacts3D
from src.tools.transformations import *
from src.tools.utils import makepath
from src.Ninjutsu.argUtils import argparseNloop


class NinjutsuDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, ind):
        ...
        annot['contacts'] = annot['contacts'][start: end: skip]
        ...
        # annot['seq'] = annot['seq'][start:end: skip]
        annot['offsets_1'] = annot['offsets_1']
        annot['offsets_2'] = annot['offsets_2']
