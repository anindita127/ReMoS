...
def argparseNloop():
    ...
    parser.add_argument('--work-dir', default = os.path.join('src', 'Lindyhop'), type=str,
                        help='The path to the downloaded data')
    parser.add_argument('--data-path', default = os.path.join('..', '..', 'DATASETS', 'LindyHop'), type=str,
    ...
    parser.add_argument('--save_dir', default = os.path.join('save', 'Lindyhop', 'diffusion'), type=str,
                        help='The path to the folder to save the processed data')
    parser.add_argument('--render_path', default = os.path.join('render', 'Lindyhop'), type=str,
                        help='The path to the folder to save the rendered output') 
    parser.add_argument('--data_dir', default = os.path.join('data', 'Lindyhop'), type=str,
                        help='The path to the pre-processed data')
    
    
    '''Dataset Parameters'''
    parser.add_argument('-dataset', nargs='+', type=str, default='LindyHopDataset',
                        help='name of the dataset')
    parser.add_argument('--frames', nargs='+', type=int, default=20,
    ...
    parser.add_argument('-batch_size', nargs='+', type=int, default=32,
                        help='minibatch size.')
    parser.add_argument('-num_epochs', nargs='+', type=int, default=300,
